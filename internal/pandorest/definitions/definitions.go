...
type Service struct {
	...
	// api-definitions directory, e.g. "prowlarr".
	Name string `json:"Name"`
	// Package is the Go package the generator writes, e.g. "prowlarr".
...
// Pageable says how a list operation pages: Prowlarr's lists take a page
