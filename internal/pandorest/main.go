// Command pandorest generates the Prowlarr SDK (lib/prowlarr) from the
// vendored OpenAPI document. It is inspired by Pandora, the
...
//	go run ./internal/pandorest generate -service prowlarr
//	go run ./internal/pandorest diff
//	go run ./internal/pandorest diff -old /tmp/old-definitions -new api-definitions/prowlarr
//
...
import (
	...
	"github.com/katbyte/prowlarr-mcp/internal/pandorest/config"
	"github.com/katbyte/prowlarr-mcp/internal/pandorest/definitions"
	"github.com/katbyte/prowlarr-mcp/internal/pandorest/differ"
	"github.com/katbyte/prowlarr-mcp/internal/pandorest/generator"
	"github.com/katbyte/prowlarr-mcp/internal/pandorest/importer"
)
...
func run(args []string, stdout, stderr io.Writer) error {
	...
	fs.SetOutput(stderr)
	services := fs.String("service", "", "comma-separated services to process (default all: prowlarr)")
