...
var miniConfig = config.Service{Name: "mini", Package: "mini", Naming: config.OperationIDNaming, TagSuffix: "Service", Auth: "Prowlarr"}
...
// not an error: Prowlarr's test-all answers 400 with every provider's result
