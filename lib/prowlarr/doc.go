...
// Package prowlarr is a typed client for Prowlarr 1.0.0, generated by internal/pandorest
// from the definitions in api-definitions/prowlarr, which were imported from docs/prowlarr-openapi.json.
//
// # Layout
//
...
//
//   - prowlarr-ui-routes
//   - prowlarr-undeclared-responses
//   - prowlarr-undeclared-write-responses
//   - prowlarr-created-accepted
//   - prowlarr-put-id-integer
//   - prowlarr-test-all-results
//   - prowlarr-command-body
//   - prowlarr-bulk-answer-lists
package prowlarr
